...
const smartLists = [
  ...
  { id: "high-priority", label: "High", icon: FiStar, color: "text-brand-primary" },
];

export default function TaskSidebar({ activeFilter, onFilterChange }: TaskSidebarProps) {
  const allFilters = [...filters, ...smartLists];
  ...
  return (
    <>
      ...
      <div className="hidden md:flex flex-col w-56 lg:w-64 p-4 bg-surface-soft border-r border-white/5 shrink-0">
        ...
        <div className="mt-auto p-4 rounded-xl bg-linear-to-br from-brand-primary/10 to-transparent border border-brand-primary/10 backdrop-blur-sm">
