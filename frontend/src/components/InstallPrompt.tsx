  ...
  if (!expanded) {
    return (
      <button 
        ...
        className="fixed bottom-24 right-4 md:bottom-8 md:right-8 w-12 h-12 bg-brand-primary text-white rounded-full shadow-[0_0_20px_rgba(var(--brand-primary),0.4)] z-50 flex items-center justify-center hover:scale-110 transition-transform"
      ...
      <div className="flex items-start justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[10px] text-text-muted leading-tight mt-0.5">Fast, native-like experience</p>
          </div>
        </div>
        <button 
