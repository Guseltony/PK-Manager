...
import { FiBook, FiCheckSquare, FiStar, FiActivity, FiZap, FiInbox, FiCalendar, FiShare2, FiTrendingUp, FiLayers, FiSettings, FiUser, FiShield, FiTarget, FiAlertTriangle, FiBarChart2 } from "react-icons/fi";
